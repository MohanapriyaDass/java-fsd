...
public class Automation {
	...
	public void LaunchChrome() {
		System.setProperty("webdriver.chrome.driver",
				"C:\\Users\\R.KAMALI\\Downloads\\chromedriver_win32\\chromedriver.exe");
		try {
			Thread.sleep(2000);
		} catch (Exception e) {
			e.printStackTrace();
...
if (newHeight == lastHeight) {
	...
	public void LaunchFirefox() {
		System.setProperty("webdriver.gecko.driver","C:\\Users\\D.MOHANAPRIYA\\Downloads\\geckodriver-v0.32.0-win32/geckodriver.exe");
		try {
			Thread.sleep(4000);
		} catch (Exception e) {
			e.printStackTrace();
